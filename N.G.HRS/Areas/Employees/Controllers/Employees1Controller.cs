...
namespace N.G.HRS.Areas.Employees.Controllers
{
    ...
    public class Employees1Controller : Controller
    {
        ...
        // GET: Employees/Employees1
        public async Task<IActionResult> Index()
        {
            var appDbContext = _context.employee.Include(e => e.Departments).Include(e => e.FingerprintDevices).Include(e => e.JobDescription).Include(e => e.Manager).Include(e => e.Sections);
            return View(await appDbContext.ToListAsync());
        }

        // GET: Employees/Employees1/Details/5
        ...
        // GET: Employees/Employees1/Create
        ...
        // POST: Employees/Employees1/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,EmployeeNumber,EmployeeName,DateOfEmployment,PlacementDate,EmploymentStatus,RehireDate,DateOfStoppingWork,UsedFingerprint,SubjectToInsurance,DateInsurance,Notes,DepartmentsId,SectionsId,JobDescriptionId,FingerprintDevicesId,ManagerId")] Employee employee)
        {
        ...
        // GET: Employees/Employees1/Edit/5
        ...
        // GET: Employees/Employees1/Delete/5
        ...
        // POST: Employees/Employees1/Delete/5
