        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    FunctionalCategoriesId = table.Column<int>(type: "int", nullable: false),
                    FunctionalClassId = table.Column<int>(type: "int", nullable: true),
                    JobRanksId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PracticalExperiencesId = table.Column<int>(type: "int", nullable: true),
                    StatementOfEmployeeFilesId = table.Column<int>(type: "int", nullable: true),
                    TrainingCoursesId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.PracticalExperiencesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    RelativesTypeId = table.Column<int>(type: "int", nullable: true),
                    EmploteeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Family", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Family_employee_Id",
                        column: x => x.Id,
                        principalTable: "employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
