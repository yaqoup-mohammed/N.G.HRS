'use strict';
var CodeMirror = require('~/textEditor/src/js/codemirror/');
require('~/textEditor/src/js/codemirror/addon/edit/continuelist.js');
require('~/textEditor/src/js/codemirror//codemirror/tablist');
require('~/textEditor/src/js/codemirror/addon/display/fullscreen.js');
require('~/textEditor/src/js/codemirror/mode/markdown/markdown.js');
require('~/textEditor/src/js/codemirror/addon/mode/overlay.js');
require('~/textEditor/src/js/codemirror/addon/display/placeholder.js');
require('~/textEditor/src/js/codemirror/addon/display/autorefresh.js');
require('~/textEditor/src/js/codemirror/addon/selection/mark-selection.js');
require('~/textEditor/src/js/codemirror/addon/search/searchcursor.js');
require('~/textEditor/src/js/codemirror/mode/gfm/gfm.js');
require('~/textEditor/src/js/codemirror/mode/xml/xml.js');
